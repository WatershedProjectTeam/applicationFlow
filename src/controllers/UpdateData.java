...
*/		
		...
		String XYLENESMP = request.getParameter("XYLENES_MP");
		String Sitename = request.getParameter("SiteName");
		String Sitepoint = request.getParameter("SitePoint");

		
/*		*****Debug		
		System.out.println("Hello UpdateData Servlet doPost!! --->Before waterQuality =" + request.getParameter("SiteName"));
		System.out.println("Hello UpdateData Servlet doPost!! --->Before waterQuality =" + request.getParameter("SitePoint"));
*/
		...
		waterQuality.setTRICHLOROETHANEa(TRICHLOROETHANE);
