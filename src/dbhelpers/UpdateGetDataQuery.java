...
public class UpdateGetDataQuery {
	...
	public List<MonitoringPoint> getMonitoringPoints(String SiteName, String SitePoint) throws SQLException {
		List<MonitoringPoint> monitoringPoints = new ArrayList<>();

		Connection connection = ConnectionBuilder.connect();
		//String query = "select distinct `SITE_NAME` from MONITORING_POINT";
		String query = "select * from MONITORING_POINT where SITE_NAME=? AND SITE_POINT=?";
