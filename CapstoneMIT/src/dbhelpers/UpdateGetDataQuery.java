...
public class UpdateGetDataQuery {

	public UpdateGetDataQuery() {
		// TODO Auto-generated constructor stub
	}
	
	public List<WaterQuality> getWaterQualities(String sampleDate, String sitepoint) throws SQLException {
		
		List<WaterQuality> waterQualities = new ArrayList<>();

		System.out.println("Hello UpdateGetDataQuery getWaterQualities Method!! "  + sampleDate  );
		
		Connection connection = ConnectionBuilder.connect();
		
		System.out.println("Hello UpdateGetDataQuery getWaterQualities Method----->WE ARE CONNECTED!! "  + sampleDate);
		
		String query = "SELECT * from water_quality where SAMPLE_DATE=? AND SITE_POINT=?";

		PreparedStatement ps = connection.prepareStatement(query);

		System.out.println("Hello UpdateGetDataQuery getWaterQualities Method----->After Prepared Statement!! "  + sitepoint);
